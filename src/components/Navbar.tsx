    ...
    <header ref={headerRef} className='pointer-events-none relative z-50 flex flex-none flex-col' style={{
      ...
      {isHomePage && (
        <>
          ...
          <div className='sm:px-8 top-0 order-last -mb-3 pt-3' style={{
      ...
      <div className='top-0 z-10 h-16 pt-6' style={{
        ...
        <div className='sm:px-8 top-(--header-top,--spacing(6)) w-full' style={{
          position: 'var(--header-inner-position)' as React.CSSProperties['position']
        }}>
          <div className='mx-auto w-full max-w-7xl lg:px-8'>
            <div className='relative px-4 sm:px-8 lg:px-12 '>
                      ...
                      <ul className='flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10'>
                        {
                          NavLinks.map((item) => (
                            <li key={item.href}>
                              <Link className='relative block px-3 py-2.5 transition hover:text-teal-500 dark:hover:text-teal-400' href={item.href}>
                                {item.label}
                              </Link>
                            </li>
                          ))
